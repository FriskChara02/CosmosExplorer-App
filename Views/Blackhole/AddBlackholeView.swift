...
struct AddBlackholeView: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle(LanguageManager.current.string("Add Your New Blackhole"))
            .background(
                ...
                ToolbarItem(placement: .confirmationAction) {
                    Button(LanguageManager.current.string("Save")) {
                        if !name.isEmpty {
                            ...
                            let newBlackhole = BlackholeModel(
                                name: name,
                                blackholeDescription: description,
                                blackhole_order: viewModel.blackholes.count,
                            ...
                            viewModel.addBlackhole(newBlackhole)
                            dismiss()
                        }
                    }
...
#Preview {
    AddBlackholeView(viewModel: BlackholeViewModel())
}
