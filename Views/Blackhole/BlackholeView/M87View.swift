...
struct M87View: View {
    ...
    private let infoItems: [String] = [
        LanguageManager.current.string("M87 Random Info 1"),
        LanguageManager.current.string("M87 Random Info 2"),
        LanguageManager.current.string("M87 Random Info 3"),
        LanguageManager.current.string("M87 Random Info 4"),
        LanguageManager.current.string("M87 Random Info 5")
    ]
        ...
        NavigationStack {
            VStack {
                ...
                HStack {
                    ...
                    Button(action: {
                        if selectedTab == "Wiki" {
                            UIPasteboard.general.string = "https://en.wikipedia.org/wiki/Messier_87"
                        } else {
                ...
                TabBarM87View(selectedTab: $selectedTab)
                ...
                VStack {
                    if selectedTab == "Overview" {
                        ...
                        GalleriesM87View(animation: animation)
                    } else if selectedTab == "Comment" {
                        CommentM87View(blackholeId: blackholeId).environmentObject(commentVM)
                    } else if selectedTab == "Wiki" {
                        VStack {
                            Text(LanguageManager.current.string("Wikipedia: M87"))
                                .font(.headline)
                                .foregroundColor(.white)
                                .padding()
                            WebView(url: URL(string: "https://en.wikipedia.org/wiki/Messier_87")!)
            ...
            .background(Image("M87_background").resizable().scaledToFill().ignoresSafeArea())
            .animation(.easeInOut(duration: 1.0), value: glowIntensity)
            .onAppear {
    ...
    var body: some View {
        ZStack {
            Image("M87")
                ...
                .padding()
                .matchedGeometryEffect(id: "m87-\(blackhole.id)", in: animation)
...
struct InformationM87View: View {
    let blackhole: BlackholeModel
    @Binding var glowIntensity: Float
            ...
            VStack {
                ...
                ScrollView {
                    VStack(alignment: .leading, spacing: 16) {
                        ...
                        Text(blackhole.aboutDescription.isEmpty ? LanguageManager.current.string("M87 About Description") : blackhole.aboutDescription)
                            .font(.body)
                            .foregroundColor(.white)
                            .padding(.horizontal)
                            .transition(.opacity)
                        ...
                        HStack {
                            ...
                            Text(LanguageManager.current.string("Video"))
                                ...
                                .foregroundColor(.white)
                            Spacer()
                            NavigationLink(destination: VideoListM87View(videoURLs: blackhole.videoURLs)) {
                        ...
                        LazyVGrid(columns: [
                            ...
                            ForEach(blackhole.videoURLs.isEmpty ? [
                                "https://www.youtube.com/embed/DqNOxoJ1OW0",
                                "https://www.youtube.com/embed/0lc05JsCIm0"
        ...
        ScrollView {
            LazyVGrid(columns: [
                ...
                ForEach(videoURLs.isEmpty ? [
                    "https://www.youtube.com/embed/DqNOxoJ1OW0",
                    "https://www.youtube.com/embed/0lc05JsCIm0",
                    "https://www.youtube.com/embed/ghoUhPbzFiQ",
                    "https://www.youtube.com/embed/t2et1Hg7W4s"
...
struct GalleriesM87View: View {
    let animation: Namespace.ID
    let images = ["M87", "M87_01", "M87_02", "M87_03", "M87_04", "M87_05"]
    
    var body: some View {
        ZStack {
            LinearGradient(
                gradient: Gradient(colors: [Color.black.opacity(0.1), Color.orange.opacity(0.4), Color.red.opacity(0.4)]),
...
#Preview {
    M87View(
        blackhole: BlackholeModel(name: "M87", blackholeDescription: "A supermassive black hole in Messier 87.", blackhole_order: 2),
