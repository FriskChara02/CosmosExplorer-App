...
struct TON618View: View {
    ...
    private let infoItems: [String] = [
        LanguageManager.current.string("TON 618 Random Info 1"),
        LanguageManager.current.string("TON 618 Random Info 2"),
        LanguageManager.current.string("TON 618 Random Info 3"),
        LanguageManager.current.string("TON 618 Random Info 4"),
        LanguageManager.current.string("TON 618 Random Info 5")
    ]
        ...
        NavigationStack {
            VStack {
                ...
                HStack {
                    ...
                    Button(action: {
                        if selectedTab == "Wiki" {
                            UIPasteboard.general.string = "https://en.wikipedia.org/wiki/TON_618"
                        } else {
                ...
                TabBarTON618View(selectedTab: $selectedTab)
                ...
                VStack {
                    if selectedTab == "Overview" {
                        ...
                        GalleriesTON618View(animation: animation)
                    } else if selectedTab == "Comment" {
                        CommentTON618View(blackholeId: blackholeId).environmentObject(commentVM)
                    } else if selectedTab == "Wiki" {
                        VStack {
                            Text(LanguageManager.current.string("Wikipedia: TON 618"))
                                .font(.headline)
                                .foregroundColor(.white)
                                .padding()
                            WebView(url: URL(string: "https://en.wikipedia.org/wiki/TON_618")!)
            ...
            .background(Image("TON618_background").resizable().scaledToFill().ignoresSafeArea())
            .animation(.easeInOut(duration: 1.0), value: glowIntensity)
            .onAppear {
...
struct OverviewTON618View: View {
    let blackhole: BlackholeModel
    ...
    var body: some View {
        ZStack {
            Image("TON618")
                ...
                .padding()
                .matchedGeometryEffect(id: "ton618-\(blackhole.id)", in: animation)
...
struct InformationTON618View: View {
    let blackhole: BlackholeModel
    @Binding var glowIntensity: Float
            ...
            VStack {
                ...
                ScrollView {
                    VStack(alignment: .leading, spacing: 16) {
                        ...
                        Text(blackhole.aboutDescription.isEmpty ? LanguageManager.current.string("TON 618 About Description") : blackhole.aboutDescription)
                            .font(.body)
                            .foregroundColor(.white)
                            .padding(.horizontal)
                            .transition(.opacity)
                        ...
                        HStack {
                            ...
                            Text(LanguageManager.current.string("Video"))
                                ...
                                .foregroundColor(.white)
                            Spacer()
                            NavigationLink(destination: VideoListTON618View(videoURLs: blackhole.videoURLs)) {
                        ...
                        LazyVGrid(columns: [
                            ...
                            ForEach(blackhole.videoURLs.isEmpty ? [
                                "https://www.youtube.com/embed/O_TNvA8BdTE",
                                "https://www.youtube.com/embed/49_bOSxxQZY"
...
struct VideoListTON618View: View {
        ...
        ScrollView {
            LazyVGrid(columns: [
                ...
                ForEach(videoURLs.isEmpty ? [
                    "https://www.youtube.com/embed/vtqWnq4RZUE",
                    "https://www.youtube.com/embed/4SK4dYuNB9I",
                    "https://www.youtube.com/embed/49_bOSxxQZY",
                    "https://www.youtube.com/embed/O_TNvA8BdTE"
...
struct GalleriesTON618View: View {
    let animation: Namespace.ID
    let images = ["TON618", "TON618_01", "TON618_02", "TON618_03", "TON618_04", "TON618_05"]
...
#Preview {
    TON618View(
        blackhole: BlackholeModel(name: "TON 618", blackholeDescription: "An ultramassive black hole.", blackhole_order: 1),
