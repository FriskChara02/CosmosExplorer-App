...
struct AddGalaxyView: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle(LanguageManager.current.string("Add Your New Galaxy"))
            .background(
                    ...
                    Button(LanguageManager.current.string("Save")) {
                        if !name.isEmpty {
                            ...
                            let newGalaxy = GalaxyModel(
                                ...
                                galaxy_order: viewModel.galaxies.count,
...
struct BasicInfoGalaxySection: View {
    ...
    var body: some View {
        Section(header: Text(LanguageManager.current.string("Basic information"))) {
            TextField(LanguageManager.current.string("Galaxy name"), text: $name)
            TextField(LanguageManager.current.string("Short description"), text: $description, axis: .vertical)
                .lineLimit(3)
            HStack {
                PhotosPicker(selection: $selectedImage, matching: .images) {
                    Text(LanguageManager.current.string("Galaxy Image"))
...
struct OverviewGalaxySection: View {
    ...
    var body: some View {
        Section(header: Text(LanguageManager.current.string("Overview"))) {
            ...
            AddButtonGalaxyViewOverview(randomInfos: $randomInfos)
            
            RemoveButtonGalaxyViewOverview(randomInfos: $randomInfos)
        }
    }
}

struct AddButtonGalaxyViewOverview: View {
    @Binding var randomInfos: [String]
...
struct RemoveButtonGalaxyViewOverview: View {
    @Binding var randomInfos: [String]
...
struct InformationGalaxySection: View {
...
struct AddButtonGalaxyViewInformation: View {
    @Binding var videoURLs: [String]
...
struct RemoveButtonGalaxyViewInformation: View {
    @Binding var videoURLs: [String]
...
struct GalleriesGalaxySection: View {
    ...
    var body: some View {
        Section(header: Text(LanguageManager.current.string("Galleries"))) {
            ...
            AddButtonGalaxyViewGalleries(galleryImages: $galleryImages, galleryImageData: $galleryImageData)
            RemoveButtonGalaxyViewGalleries(galleryImages: $galleryImages, galleryImageData: $galleryImageData)
        }
        .id(galleryImages.count)
    }
}

struct AddButtonGalaxyViewGalleries: View {
    @Binding var galleryImages: [PhotosPickerItem?]
    @Binding var galleryImageData: [Data?]
...
struct RemoveButtonGalaxyViewGalleries: View {
    @Binding var galleryImages: [PhotosPickerItem?]
    @Binding var galleryImageData: [Data?]
...
#Preview {
    AddGalaxyView(viewModel: GalaxyViewModel())
}
