...
struct M32View: View {
    ...
    private let infoItems: [String] = [
        ...
        LanguageManager.current.string("M32 Random Info 2"),
        LanguageManager.current.string("M32 Random Info 3"),
        LanguageManager.current.string("M32 Random Info 4"),
        LanguageManager.current.string("M32 Random Info 5")
    ]
        ...
        NavigationStack {
            VStack {
                ...
                HStack {
                    ...
                    Button(action: {
                        if selectedTab == "Wiki" {
                            UIPasteboard.general.string = "https://en.wikipedia.org/wiki/Messier_32"
                        } else {
                ...
                TabBarM32View(selectedTab: $selectedTab)
                    ...
                    if selectedTab == "Overview" {
                        ...
                        VStack {
                            Text(LanguageManager.current.string("Wikipedia: Messier 32"))
                                ...
                                .foregroundColor(.white)
                                .padding()
                            WebView(url: URL(string: "https://en.wikipedia.org/wiki/Messier_32")!)
    ...
    var body: some View {
        ZStack {
            Image("M32")
                ...
                .padding()
                .matchedGeometryEffect(id: "m32-\(galaxy.id)", in: animation)
...
struct InformationM32View: View {
    let galaxy: GalaxyModel
    @Binding var glowIntensity: Float
            ...
            VStack {
                ...
                ScrollView {
                    VStack(alignment: .leading, spacing: 16) {
                        ...
                        Text(galaxy.aboutDescription.isEmpty ? LanguageManager.current.string("M32 About Description") : galaxy.aboutDescription)
                            .font(.body)
                            .foregroundColor(.white)
                            .padding(.horizontal)
                            .transition(.opacity)
                        ...
                        HStack {
                            ...
                            Text(LanguageManager.current.string("Video"))
                                ...
                                .foregroundColor(.white)
                            Spacer()
                            NavigationLink(destination: VideoListM32View(videoURLs: galaxy.videoURLs)) {
                        ...
                        LazyVGrid(columns: [
                            ...
                            ForEach(galaxy.videoURLs.isEmpty ? [
                                "https://www.youtube.com/embed/JDwI_XEz_KE",
                                "https://www.youtube.com/embed/p0k3qG6dxas"
        ...
        ScrollView {
            LazyVGrid(columns: [
                ...
                ForEach(videoURLs.isEmpty ? [
                    "https://www.youtube.com/embed/JDwI_XEz_KE",
                    "https://www.youtube.com/embed/p0k3qG6dxas",
                    "https://www.youtube.com/embed/VhebE2FSxt4"
...
struct GalleriesM32View: View {
    let animation: Namespace.ID
    let images = ["M32", "M32_01", "M32_02", "M32_03", "M32_04", "M32_05", "M32_06", "M32_07"]
...
#Preview {
    M32View(
        galaxy: GalaxyModel(name: "M32", galaxyDescription: "A dwarf elliptical galaxy.", galaxy_order: 1),
