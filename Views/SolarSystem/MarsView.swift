...
struct MarsView: View {
    ...
    private let infoItems: [String] = [
        ...
        LanguageManager.current.string("Mars Random Info 3"),
        ...
        NavigationStack {
            VStack {
                ...
                HStack {
                    ...
                    Button(action: {
                        if selectedTab == "Wiki" {
                            UIPasteboard.general.string = "https://en.wikipedia.org/wiki/Mars"
                        } else {
                ...
                VStack {
                    if selectedTab == "Overview" {
                        ...
                        VStack {
                            Text(LanguageManager.current.string("Wikipedia: Mars"))
                                .font(.headline)
                                .foregroundColor(.white)
                                .padding()
                            WebView(url: URL(string: "https://en.wikipedia.org/wiki/Mars")!)
        ...
        var body: some View {
            ZStack {
                RealityView { content in
                    ...
                    marsMaterial.emissiveIntensity = glowIntensity
                    ...
                    Task { @MainActor in
                        ...
                        while true {
                            ...
                            marsEntity.transform.rotation = rotationY * rotationX
                ...
                .frame(height: 300)
                .padding()
                .matchedGeometryEffect(id: "mars-\(planet.id)", in: animation)
                .gesture(
                    DragGesture()
                        .onChanged { value in
                            isDragging = true
    ...
    struct InformationView: View {
        ...
        var body: some View {
            GeometryReader { geometry in
                VStack {
                    RealityView { content in
                        let marsMesh = MeshResource.generateSphere(radius: 0.5)
                        var marsMaterial = PhysicallyBasedMaterial()
                        do {
                            let textureResource = try await TextureResource(named: "Mars_Texture")
                            marsMaterial.baseColor = .init(texture: .init(textureResource))
                        ...
                        Task { @MainActor in
                            ...
                            while true {
                                ...
                                marsEntity.transform.rotation = rotation
                                try? await Task.sleep(nanoseconds: 16_666_666)
                            }
                        }
                    }
                    ...
                    ScrollView {
                        VStack(alignment: .leading, spacing: 16) {
                            ...
                            Text(LanguageManager.current.string("Mars About Description"))
                                .font(.body)
                                .foregroundColor(.white)
                                .padding(.horizontal)
                                .transition(.opacity)
                            ...
                            LazyVGrid(columns: [
                                ...
                                ForEach([
                                    "https://www.youtube.com/embed/D8pnmwOXhoY",
                                    "https://www.youtube.com/embed/rw_OgA9x7B8"
                                ],  id: \.self) { url in
    ...
    struct VideoListView: View {
        let videoURLs = [
            "https://www.youtube.com/embed/D8pnmwOXhoY",
            "https://www.youtube.com/embed/rw_OgA9x7B8",
            "https://www.youtube.com/embed/WU4u4la_mM4",
            "https://www.youtube.com/embed/fhtw7Dpntb4",
            "https://www.youtube.com/embed/n--9w6zt9MM",
            "https://www.youtube.com/embed/QoSFyHIsM90",
    ...
    struct ByTheNumbersView: View {
        var body: some View {
            ScrollView {
                VStack(alignment: .leading, spacing: 2) {
                    infoRow(icon: "star.fill", color: .yellow,
                            text: LanguageManager.current.string("Mars By The Numbers Planet Type"))
                    infoRow(icon: "circle.fill", color: .orange,
                            text: LanguageManager.current.string("Mars By The Numbers Radius"))
                    infoRow(icon: "sun.max.fill", color: .red,
                            text: LanguageManager.current.string("Mars By The Numbers Distance"))
                    infoRow(icon: "moon.fill", color: .gray,
                            text: LanguageManager.current.string("Mars By The Numbers Moons"))
                    infoRow(icon: "gauge", color: .green,
                            text: LanguageManager.current.string("Mars By The Numbers Gravity"))
                    infoRow(icon: "arrow.triangle.2.circlepath", color: .blue,
                            text: LanguageManager.current.string("Mars By The Numbers Tilt"))
                    infoRow(icon: "calendar", color: .purple,
                            text: LanguageManager.current.string("Mars By The Numbers Year"))
                    infoRow(icon: "clock", color: .pink,
                            text: LanguageManager.current.string("Mars By The Numbers Day"))
                    infoRow(icon: "thermometer", color: .red,
                            text: LanguageManager.current.string("Mars By The Numbers Temperature"))
                    infoRow(icon: "hourglass", color: .teal,
                            text: LanguageManager.current.string("Mars By The Numbers Age"))
                }
                .padding()
            ...
            .background(
                LinearGradient(
                    gradient: Gradient(colors: [Color.black, Color.red.opacity(0.3)]),
                    startPoint: .top,
                    endPoint: .bottom
                )
                .ignoresSafeArea()
    ...
    struct GalleriesView: View {
        ...
        var body: some View {
            ZStack {
                LinearGradient(
                    gradient: Gradient(colors: [Color.black, Color.red.opacity(0.4), Color.orange.opacity(0.4)]),
                                    ...
                                    .overlay(
                                        RoundedRectangle(cornerRadius: 16)
                                            .stroke(LinearGradient(
                                                gradient: Gradient(colors: [.red, .orange, .clear]),
                                                startPoint: .topLeading,
                                                endPoint: .bottomTrailing
                                            ), lineWidth: 2)
                                    )
    ...
    struct MythView: View {
        ...
        private let myths: [Myth] = [
            Myth(culture: LanguageManager.current.string("Roman Myth Culture"), godName: LanguageManager.current.string("Roman Myth God"), description: LanguageManager.current.string("Roman Myth Description"), imageName: "MarsGod_Mars"),
            Myth(culture: LanguageManager.current.string("Greek Myth Culture"), godName: LanguageManager.current.string("Greek Myth God"), description: LanguageManager.current.string("Greek Myth Description"), imageName: "MarsGod_Ares"),
            Myth(culture: LanguageManager.current.string("Egyptian Myth Culture"), godName: LanguageManager.current.string("Egyptian Myth God"), description: LanguageManager.current.string("Egyptian Myth Description"), imageName: "MarsGod_Horus"),
            Myth(culture: LanguageManager.current.string("Norse Myth Culture"), godName: LanguageManager.current.string("Norse Myth God"), description: LanguageManager.current.string("Norse Myth Description"), imageName: "MarsGod_Tyr")
        ]
        ...
        var body: some View {
            ZStack {
                ...
                ScrollView {
                    VStack(spacing: 24) {
                        VStack(spacing: 8) {
                            Text(LanguageManager.current.string("Mars Myths Title"))
                                .font(.title.bold())
                                .foregroundColor(.white)
                            Text(LanguageManager.current.string("Mars Myths Description"))
                                .font(.body)
                                .foregroundColor(.white.opacity(0.8))
    ...
    struct InternalView: View {
        ...
        private let layers: [MarsLayer] = [
            MarsLayer(
                name: LanguageManager.current.string("Mars Layer Core"),
                description: LanguageManager.current.string("Mars Layer Core Description"),
                color: LinearGradient(colors: [.red, .orange], startPoint: .topLeading, endPoint: .bottomTrailing),
                icon: "flame.fill"
            ),
            MarsLayer(
                name: LanguageManager.current.string("Mars Layer Mantle"),
                description: LanguageManager.current.string("Mars Layer Mantle Description"),
                color: LinearGradient(colors: [.orange, .brown], startPoint: .topLeading, endPoint: .bottomTrailing),
                icon: "square.stack.3d.down.right.fill"
            ),
            MarsLayer(
                name: LanguageManager.current.string("Mars Layer Crust"),
                description: LanguageManager.current.string("Mars Layer Crust Description"),
                color: LinearGradient(colors: [.brown, .red], startPoint: .top, endPoint: .bottom),
                icon: "globe.americas.fill"
            ),
            MarsLayer(
                name: LanguageManager.current.string("Mars Layer Atmosphere"),
                description: LanguageManager.current.string("Mars Layer Atmosphere Description"),
                color: LinearGradient(colors: [.red, .gray], startPoint: .leading, endPoint: .trailing),
                icon: "cloud.fill"
            )
        ]
        ...
        var body: some View {
            ScrollView {
                VStack(spacing: 20) {
                    Text(LanguageManager.current.string("Mars Internal Title"))
                        .font(.title2)
                        .fontWeight(.bold)
                        .foregroundColor(.white)
                        .padding(.top, 10)
                    ...
                    Image("Mars")
                        ...
                        .clipShape(RoundedRectangle(cornerRadius: 12))
                        .padding()
                        .matchedGeometryEffect(id: "internal-mars", in: animation)
                }
                .padding(.bottom, 30)
            }
            .background(
            ...
            ScrollView {
                VStack(spacing: 20) {
                    Image("Mars")
                        ...
                        .shadow(radius: 8)
                        .padding(.horizontal)
                        .matchedGeometryEffect(id: "indepth-mars", in: animation)
                    
                    Text(LanguageManager.current.string("Mars In Depth Title"))
                        .font(.title2.bold())
                        .foregroundColor(.white)
                        .padding(.horizontal)
                    ...
                    VStack(spacing: 16) {
                        InfoCardView(
                            ...
                            title: LanguageManager.current.string("Mars In Depth Olympus Mons"),
                            description: LanguageManager.current.string("Mars In Depth Olympus Mons Description"),
                            iconColor: .red
                        )
                        InfoCardView(
                            icon: "drop.fill",
                            title: LanguageManager.current.string("Mars In Depth Water Evidence"),
                            description: LanguageManager.current.string("Mars In Depth Water Evidence Description"),
                            iconColor: .blue
                        )
                        InfoCardView(
                            icon: "wind",
                            title: LanguageManager.current.string("Mars In Depth Atmosphere"),
                            description: LanguageManager.current.string("Mars In Depth Atmosphere Description"),
                            iconColor: .gray
                        )
                        InfoCardView(
                            icon: "airplane",
                            title: LanguageManager.current.string("Mars In Depth Missions"),
                            description: LanguageManager.current.string("Mars In Depth Missions Description"),
                            iconColor: .green
                        )
                    }
                    .padding(.horizontal)
            ...
            ScrollView {
                VStack(spacing: 24) {
                    ZStack(alignment: .bottomLeading) {
                        ...
                        Text(LanguageManager.current.string("Mars Exploration Title"))
                    ...
                    VStack(alignment: .leading, spacing: 16) {
                        MissionCardView(
                            title: LanguageManager.current.string("Mars Mission Viking"),
                            description: LanguageManager.current.string("Mars Mission Viking Description"),
                            icon: "camera.metering.matrix",
                            animation: animation,
                            id: "viking"
                        )
                        MissionCardView(
                            title: LanguageManager.current.string("Mars Mission Curiosity"),
                            description: LanguageManager.current.string("Mars Mission Curiosity Description"),
                            icon: "moon.stars.circle",
                            animation: animation,
                            id: "curiosity"
                        )
                        MissionCardView(
                            title: LanguageManager.current.string("Mars Mission Perseverance"),
                            description: LanguageManager.current.string("Mars Mission Perseverance Description"),
                    ...
                    Text(LanguageManager.current.string("Mars Exploration Quote"))
                        .font(.title3.italic())
...
#Preview {
    MarsView(
        planet: PlanetModel(name: "Mars", planetDescription: "The Red Planet, known for its iron-rich dust and ancient river valleys."),
