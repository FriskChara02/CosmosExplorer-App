...
struct EarthView: View {
    ...
    private let infoItems: [String] = [
        LanguageManager.current.string("Earth Random Info 1"),
        LanguageManager.current.string("Earth Random Info 2"),
        LanguageManager.current.string("Earth Random Info 3"),
        LanguageManager.current.string("Earth Random Info 4"),
        LanguageManager.current.string("Earth Random Info 5")
    ]
        ...
        NavigationStack {
            VStack {
                ...
                HStack {
                    ...
                    Button(action: {
                        if selectedTab == "Wiki" {
                            UIPasteboard.general.string = "https://en.wikipedia.org/wiki/Earth"
                        } else {
                ...
                VStack {
                    if selectedTab == "Overview" {
                        ...
                        VStack {
                            Text(LanguageManager.current.string("Wikipedia: Earth"))
                                .font(.headline)
                                .foregroundColor(.white)
                                .padding()
                            WebView(url: URL(string: "https://en.wikipedia.org/wiki/Earth")!)
                        ...
                        CommentEarthView(planetId: planetId).environmentObject(commentVM)
                    } else {
        ...
        var body: some View {
            ZStack {
                RealityView { content in
                    ...
                    earthMaterial.emissiveIntensity = glowIntensity
                    ...
                    Task { @MainActor in
                        ...
                        while true {
                            ...
                            earthEntity.transform.rotation = rotationY * rotationX
                ...
                .frame(height: 300)
                .padding()
                .matchedGeometryEffect(id: "earth-\(planet.id)", in: animation)
                .gesture(
                    DragGesture()
                        .onChanged { value in
                            isDragging = true
                ...
                VStack {
                    RealityView { content in
                        ...
                        Task { @MainActor in
                            ...
                            while true {
                                ...
                                earthEntity.transform.rotation = rotation
                                try? await Task.sleep(nanoseconds: 16_666_666)
                            }
                        }
                    }
                    ...
                    ScrollView {
                        VStack(alignment: .leading, spacing: 16) {
                            ...
                            Text(LanguageManager.current.string("Earth About Description"))
                                .font(.body)
                                .foregroundColor(.white)
                                .padding(.horizontal)
                                .transition(.opacity)
                            ...
                            LazyVGrid(columns: [
                                ...
                                ForEach([
                                    "https://www.youtube.com/embed/S7TUe5w6RHo",
                                    "https://www.youtube.com/embed/IDhapt7nw4A"
                                ],  id: \.self) { url in
    ...
    struct VideoListView: View {
        let videoURLs = [
            "https://www.youtube.com/embed/JGXi_9A__Vc",
            "https://www.youtube.com/embed/IDhapt7nw4A",
            "https://www.youtube.com/embed/uAwTWAC0vt0",
            "https://www.youtube.com/embed/tVQ5H4RNirk",
            "https://www.youtube.com/embed/GBMpeBXCRkk",
            "https://www.youtube.com/embed/S7TUe5w6RHo"
        ]
        ...
        var body: some View {
            ScrollView {
                VStack(alignment: .leading, spacing: 2) {
                    infoRow(icon: "globe", color: .blue,
                            text: LanguageManager.current.string("Earth By The Numbers Planet Type"))
                    infoRow(icon: "circle.fill", color: .green,
                            text: LanguageManager.current.string("Earth By The Numbers Radius"))
                    infoRow(icon: "sun.max.fill", color: .yellow,
                            text: LanguageManager.current.string("Earth By The Numbers Distance"))
                    infoRow(icon: "moon.fill", color: .gray,
                            text: LanguageManager.current.string("Earth By The Numbers Moons"))
                    infoRow(icon: "gauge", color: .cyan,
                            text: LanguageManager.current.string("Earth By The Numbers Gravity"))
                    infoRow(icon: "arrow.triangle.2.circlepath", color: .purple,
                            text: LanguageManager.current.string("Earth By The Numbers Tilt"))
                    infoRow(icon: "calendar", color: .orange,
                            text: LanguageManager.current.string("Earth By The Numbers Year"))
                    infoRow(icon: "clock", color: .pink,
                            text: LanguageManager.current.string("Earth By The Numbers Day"))
                    infoRow(icon: "thermometer", color: .red,
                            text: LanguageManager.current.string("Earth By The Numbers Temperature"))
                    infoRow(icon: "hourglass", color: .teal,
                            text: LanguageManager.current.string("Earth By The Numbers Age"))
                }
                .padding()
    ...
    struct GalleriesView: View {
        let animation: Namespace.ID
        let images = ["Earth", "Earth01", "Earth02", "Earth03", "Earth04", "Earth05"]
        
        var body: some View {
            ZStack {
                LinearGradient(
                    gradient: Gradient(colors: [Color.black, Color.blue.opacity(0.4), Color.green.opacity(0.4)]),
                                    ...
                                    .overlay(
                                        RoundedRectangle(cornerRadius: 16)
                                            .stroke(LinearGradient(
                                                gradient: Gradient(colors: [.blue, .green, .clear]),
                                                startPoint: .topLeading,
                                                endPoint: .bottomTrailing
                                            ), lineWidth: 2)
                                    )
    ...
    struct MythView: View {
        ...
        private let myths: [Myth] = [
            Myth(culture: LanguageManager.current.string("Egyptian Myth Culture"), godName: LanguageManager.current.string("Egyptian Myth God"), description: LanguageManager.current.string("Egyptian Myth Description"), imageName: "EarthGod_Geb"),
            Myth(culture: LanguageManager.current.string("Greek Myth Culture"), godName: LanguageManager.current.string("Greek Myth God"), description: LanguageManager.current.string("Greek Myth Description"), imageName: "EarthGod_Gaia"),
            Myth(culture: LanguageManager.current.string("Norse Myth Culture"), godName: LanguageManager.current.string("Norse Myth God"), description: LanguageManager.current.string("Norse Myth Description"), imageName: "EarthGod_Jord"),
            Myth(culture: LanguageManager.current.string("Inca Myth Culture"), godName: LanguageManager.current.string("Inca Myth God"), description: LanguageManager.current.string("Inca Myth Description"), imageName: "EarthGod_Pachamama")
        ]
        ...
        var body: some View {
            ZStack {
                ...
                ScrollView {
                    VStack(spacing: 24) {
                        VStack(spacing: 8) {
                            Text(LanguageManager.current.string("Earth Myths Title"))
                                .font(.title.bold())
                                .foregroundColor(.white)
                            
                            Text(LanguageManager.current.string("Earth Myths Description"))
                                .font(.body)
                                .foregroundColor(.white.opacity(0.8))
    ...
    struct InternalView: View {
        ...
        struct EarthLayer: Identifiable {
            let id = UUID()
            let name: String
            let description: String
        ...
        private let layers: [EarthLayer] = [
            EarthLayer(
                name: LanguageManager.current.string("Earth Layer Core"),
                description: LanguageManager.current.string("Earth Layer Core Description"),
                color: LinearGradient(colors: [.red, .orange], startPoint: .topLeading, endPoint: .bottomTrailing),
                icon: "flame.fill"
            ),
            EarthLayer(
                name: LanguageManager.current.string("Earth Layer Mantle"),
                description: LanguageManager.current.string("Earth Layer Mantle Description"),
                color: LinearGradient(colors: [.orange, .brown], startPoint: .topLeading, endPoint: .bottomTrailing),
                icon: "globe.asia.australia.fill"
            ),
            EarthLayer(
                name: LanguageManager.current.string("Earth Layer Crust"),
                description: LanguageManager.current.string("Earth Layer Crust Description"),
                color: LinearGradient(colors: [.brown, .green], startPoint: .top, endPoint: .bottom),
                icon: "leaf.fill"
            ),
            EarthLayer(
                name: LanguageManager.current.string("Earth Layer Atmosphere"),
                description: LanguageManager.current.string("Earth Layer Atmosphere Description"),
                color: LinearGradient(colors: [.blue, .cyan], startPoint: .leading, endPoint: .trailing),
                icon: "cloud.fill"
            )
        ]
        ...
        var body: some View {
            ScrollView {
                VStack(spacing: 20) {
                    Text(LanguageManager.current.string("Earth Internal Title"))
                        .font(.title2)
                        .fontWeight(.bold)
                        .foregroundColor(.white)
                        .padding(.top, 10)
                    ...
                    Image("Earth")
                        ...
                        .clipShape(RoundedRectangle(cornerRadius: 12))
                        .padding()
                        .matchedGeometryEffect(id: "internal-earth", in: animation)
                }
                .padding(.bottom, 30)
            }
            .background(
            ...
            ScrollView {
                VStack(spacing: 20) {
                    Image("Earth")
                        ...
                        .shadow(radius: 8)
                        .padding(.horizontal)
                        .matchedGeometryEffect(id: "indepth-earth", in: animation)
                    
                    Text(LanguageManager.current.string("Earth In Depth Title"))
                        .font(.title2.bold())
                        .foregroundColor(.white)
                        .padding(.horizontal)
                    ...
                    VStack(spacing: 16) {
                        InfoCardView(
                            icon: "globe.asia.australia.fill",
                            title: LanguageManager.current.string("Earth In Depth Continents"),
                            description: LanguageManager.current.string("Earth In Depth Continents Description"),
                            iconColor: .green
                        )
                        
                        InfoCardView(
                            icon: "drop.fill",
                            title: LanguageManager.current.string("Earth In Depth Oceans"),
                            description: LanguageManager.current.string("Earth In Depth Oceans Description"),
                            iconColor: .blue
                        )
                        
                        InfoCardView(
                            icon: "cloud.fill",
                            title: LanguageManager.current.string("Earth In Depth Atmosphere"),
                            description: LanguageManager.current.string("Earth In Depth Atmosphere Description"),
                            iconColor: .cyan
                        )
                        
                        InfoCardView(
                            icon: "binoculars.fill",
                            title: LanguageManager.current.string("Earth In Depth Missions"),
                            description: LanguageManager.current.string("Earth In Depth Missions Description"),
                            iconColor: .purple
                        )
                    }
                    .padding(.horizontal)
            ...
            ScrollView {
                VStack(spacing: 24) {
                    ZStack(alignment: .bottomLeading) {
                        ...
                        Text(LanguageManager.current.string("Earth Exploration Title"))
                    ...
                    VStack(alignment: .leading, spacing: 16) {
                        MissionCardView(
                            title: LanguageManager.current.string("Earth Mission Apollo"),
                            description: LanguageManager.current.string("Earth Mission Apollo Description"),
                            icon: "moon.fill",
                            animation: animation,
                            id: "apollo"
                        )
                        ...
                        MissionCardView(
                            title: LanguageManager.current.string("Earth Mission ISS"),
                            description: LanguageManager.current.string("Earth Mission ISS Description"),
                            icon: "airplane",
                            animation: animation,
                            id: "iss"
                        )
                        ...
                        MissionCardView(
                            title: LanguageManager.current.string("Earth Mission Hubble"),
                            description: LanguageManager.current.string("Earth Mission Hubble Description"),
                    ...
                    Text(LanguageManager.current.string("Earth Exploration Quote"))
                        .font(.title3.italic())
...
#Preview {
    EarthView(
        planet: PlanetModel(name: "Earth", planetDescription: "The third planet from the Sun, home to diverse life forms."),
