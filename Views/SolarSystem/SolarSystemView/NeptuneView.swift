...
struct NeptuneView: View {
    ...
    @State private var glowIntensity: Float = 0.7
    ...
    private let infoItems: [String] = [
        LanguageManager.current.string("Neptune Random Info 1"),
        LanguageManager.current.string("Neptune Random Info 2"),
        LanguageManager.current.string("Neptune Random Info 3"),
        LanguageManager.current.string("Neptune Random Info 4"),
        LanguageManager.current.string("Neptune Random Info 5")
    ]
        ...
        NavigationStack {
            VStack {
                ...
                HStack {
                    ...
                    Button(action: {
                        if selectedTab == "Wiki" {
                            UIPasteboard.general.string = "https://en.wikipedia.org/wiki/Neptune"
                        } else {
                ...
                VStack {
                    if selectedTab == "Overview" {
                        ...
                        VStack {
                            Text(LanguageManager.current.string("Wikipedia: Neptune"))
                                .font(.headline)
                                .foregroundColor(.white)
                                .padding()
                            WebView(url: URL(string: "https://en.wikipedia.org/wiki/Neptune")!)
                        ...
                        CommentNeptuneView(planetId: planetId).environmentObject(commentVM)
                    } else {
        ...
        var body: some View {
            ZStack {
                RealityView { content in
                    let neptuneMesh = MeshResource.generateSphere(radius: 1.0)
                    ...
                    neptuneMaterial.emissiveIntensity = glowIntensity
                    ...
                    neptuneEntity.addChild(cloudEntity)
                    ...
                    Task { @MainActor in
                        ...
                        while true {
                            ...
                            neptuneEntity.transform.rotation = rotationY * rotationX
                ...
                .frame(height: 300)
                .padding()
                .matchedGeometryEffect(id: "neptune-\(planet.id)", in: animation)
                .gesture(
                    DragGesture()
                        .onChanged { value in
                            isDragging = true
    ...
    struct InformationView: View {
        ...
        var body: some View {
            GeometryReader { geometry in
                VStack {
                    RealityView { content in
                        let neptuneMesh = MeshResource.generateSphere(radius: 0.5)
                        var neptuneMaterial = PhysicallyBasedMaterial()
                        do {
                            let textureResource = try await TextureResource(named: "Neptune_Texture")
                            neptuneMaterial.baseColor = .init(texture: .init(textureResource))
                        ...
                        Task { @MainActor in
                            ...
                            while true {
                                ...
                                neptuneEntity.transform.rotation = rotation
                                try? await Task.sleep(nanoseconds: 16_666_666)
                            }
                        }
                    }
                    ...
                    ScrollView {
                        VStack(alignment: .leading, spacing: 16) {
                            ...
                            Text(LanguageManager.current.string("Neptune About Description"))
                                .font(.body)
                                .foregroundColor(.white)
                                .padding(.horizontal)
                                .transition(.opacity)
                            ...
                            LazyVGrid(columns: [
                                ...
                                ForEach([
                                    "https://www.youtube.com/embed/NStn7zZKXfE",
                                    "https://www.youtube.com/embed/NwEZKjkRgeY"
                                ],  id: \.self) { url in
    ...
    struct VideoListView: View {
        let videoURLs = [
            "https://www.youtube.com/embed/NStn7zZKXfE",
            "https://www.youtube.com/embed/NwEZKjkRgeY",
            "https://www.youtube.com/embed/HdqEzUGkytQ",
            "https://www.youtube.com/embed/RsdHLvjh1To",
            "https://www.youtube.com/embed/yQ4kf79fKaQ",
            "https://www.youtube.com/embed/DhLm_4pBrso",
            "https://www.youtube.com/embed/9t4pbupa1oQ"
        ]
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 2) {
                    infoRow(icon: "star.fill", color: .blue,
                            text: LanguageManager.current.string("Neptune By The Numbers Planet Type"))
                    
                    infoRow(icon: "circle.fill", color: .cyan,
                            text: LanguageManager.current.string("Neptune By The Numbers Radius"))
                    
                    infoRow(icon: "sun.max.fill", color: .purple,
                            text: LanguageManager.current.string("Neptune By The Numbers Distance"))
                    
                    infoRow(icon: "moon.fill", color: .gray,
                            text: LanguageManager.current.string("Neptune By The Numbers Moons"))
                    
                    infoRow(icon: "gauge", color: .green,
                            text: LanguageManager.current.string("Neptune By The Numbers Gravity"))
                    
                    infoRow(icon: "arrow.triangle.2.circlepath", color: .blue,
                            text: LanguageManager.current.string("Neptune By The Numbers Tilt"))
                    
                    infoRow(icon: "calendar", color: .purple,
                            text: LanguageManager.current.string("Neptune By The Numbers Year"))
                    
                    infoRow(icon: "clock", color: .pink,
                            text: LanguageManager.current.string("Neptune By The Numbers Day"))
                    
                    infoRow(icon: "thermometer", color: .cyan,
                            text: LanguageManager.current.string("Neptune By The Numbers Temperature"))
                    
                    infoRow(icon: "hourglass", color: .teal,
                            text: LanguageManager.current.string("Neptune By The Numbers Age"))
                }
                .padding()
    ...
    struct GalleriesView: View {
        ...
        let images = ["Neptune", "Neptune01", "Neptune02", "Neptune03", "Neptune04", "Neptune05"]
        
        var body: some View {
            ZStack {
                // 🌌 Cosmos Background
                LinearGradient(
                    gradient: Gradient(colors: [Color.black, Color.blue.opacity(0.4), Color.cyan.opacity(0.4)]),
                                    ...
                                    .overlay(
                                        RoundedRectangle(cornerRadius: 16)
                                            .stroke(LinearGradient(
                                                gradient: Gradient(colors: [.blue, .cyan, .clear]),
                                                startPoint: .topLeading,
                                                endPoint: .bottomTrailing
                                            ), lineWidth: 2)
                                    )
    ...
    struct MythView: View {
        ...
        private let myths: [Myth] = [
            Myth(culture: LanguageManager.current.string("Greek Myth Culture"), godName: LanguageManager.current.string("Greek Myth God"), description: LanguageManager.current.string("Greek Myth Description"), imageName: "NeptuneGod_Poseidon"),
            Myth(culture: LanguageManager.current.string("Roman Myth Culture"), godName: LanguageManager.current.string("Roman Myth God"), description: LanguageManager.current.string("Roman Myth Description"), imageName: "NeptuneGod_Neptune"),
            Myth(culture: LanguageManager.current.string("Hindu Myth Culture"), godName: LanguageManager.current.string("Hindu Myth God"), description: LanguageManager.current.string("Hindu Myth Description"), imageName: "NeptuneGod_Varuna"),
            Myth(culture: LanguageManager.current.string("Maori Myth Culture"), godName: LanguageManager.current.string("Maori Myth God"), description: LanguageManager.current.string("Maori Myth Description"), imageName: "NeptuneGod_Tangaroa")
        ]
            ...
            ZStack {
                ...
                ScrollView {
                    VStack(spacing: 24) {
                        // Header
                        VStack(spacing: 8) {
                            Text(LanguageManager.current.string("Neptune Myths Title"))
                                .font(.title.bold())
                                .foregroundColor(.white)
                            
                            Text(LanguageManager.current.string("Neptune Myths Description"))
                                .font(.body)
                                .foregroundColor(.white.opacity(0.8))
    ...
    struct InternalView: View {
        ...
        struct NeptuneLayer: Identifiable {
            let id = UUID()
            let name: String
            let description: String
        ...
        private let layers: [NeptuneLayer] = [
            NeptuneLayer(
                name: LanguageManager.current.string("Neptune Layer Core"),
                description: LanguageManager.current.string("Neptune Layer Core Description"),
                color: LinearGradient(colors: [.blue, .cyan], startPoint: .topLeading, endPoint: .bottomTrailing),
                icon: "circle.fill"
            ),
            NeptuneLayer(
                name: LanguageManager.current.string("Neptune Layer Mantle"),
                description: LanguageManager.current.string("Neptune Layer Mantle Description"),
                color: LinearGradient(colors: [.cyan, .white], startPoint: .topLeading, endPoint: .bottomTrailing),
                icon: "waveform.path.ecg"
            ),
            NeptuneLayer(
                name: LanguageManager.current.string("Neptune Layer Atmosphere"),
                description: LanguageManager.current.string("Neptune Layer Atmosphere Description"),
        ...
        var body: some View {
            ScrollView {
                VStack(spacing: 20) {
                    Text(LanguageManager.current.string("Neptune Internal Title"))
                        .font(.title2)
                        .fontWeight(.bold)
                        .foregroundColor(.white)
                        .padding(.top, 10)
                    ...
                    Image("Neptune")
                        ...
                        .clipShape(RoundedRectangle(cornerRadius: 12))
                        .padding()
                        .matchedGeometryEffect(id: "internal-neptune", in: animation)
                }
                .padding(.bottom, 30)
            }
            .background(
            ...
            ScrollView {
                VStack(spacing: 20) {
                    ...
                    Image("Neptune")
                        ...
                        .shadow(radius: 8)
                        .padding(.horizontal)
                        .matchedGeometryEffect(id: "indepth-neptune", in: animation)
                    
                    // Title
                    Text(LanguageManager.current.string("Neptune In Depth Title"))
                        .font(.title2.bold())
                        .foregroundColor(.white)
                        .padding(.horizontal)
                    ...
                    VStack(spacing: 16) {
                        InfoCardView(
                            icon: "cloud.fill",
                            title: LanguageManager.current.string("Neptune In Depth Atmosphere"),
                            description: LanguageManager.current.string("Neptune In Depth Atmosphere Description"),
                            iconColor: .blue
                        )
                        
                        InfoCardView(
                            icon: "moon.fill",
                            title: LanguageManager.current.string("Neptune In Depth Moons"),
                            description: LanguageManager.current.string("Neptune In Depth Moons Description"),
                            iconColor: .cyan
                        )
                        
                        InfoCardView(
                            icon: "wind",
                            title: LanguageManager.current.string("Neptune In Depth Winds"),
                            description: LanguageManager.current.string("Neptune In Depth Winds Description"),
                            iconColor: .purple
                        )
                        
                        InfoCardView(
                            icon: "airplane",
                            title: LanguageManager.current.string("Neptune In Depth Missions"),
                            description: LanguageManager.current.string("Neptune In Depth Missions Description"),
                            iconColor: .green
                        )
                    }
                    .padding(.horizontal)
            ...
            ScrollView {
                VStack(spacing: 24) {
                    ...
                    ZStack(alignment: .bottomLeading) {
                        ...
                        Text(LanguageManager.current.string("Neptune Exploration Title"))
                    ...
                    VStack(alignment: .leading, spacing: 16) {
                        MissionCardView(
                            title: LanguageManager.current.string("Neptune Mission Voyager 2"),
                            description: LanguageManager.current.string("Neptune Mission Voyager 2 Description"),
                    ...
                    // ✨ Highlight Quote
                    Text(LanguageManager.current.string("Neptune Exploration Quote"))
                        .font(.title3.italic())
    ...
    struct CommentNeptuneView: View {
...
#Preview {
    NeptuneView(
        planet: PlanetModel(name: "Neptune", planetDescription: "The eighth planet from the Sun, known for its deep blue atmosphere.", planet_order: 8),
