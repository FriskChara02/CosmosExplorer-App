...
struct VenusView: View {
    ...
    private let infoItems: [String] = [
        LanguageManager.current.string("Venus Random Info 1"),
        LanguageManager.current.string("Venus Random Info 2"),
        LanguageManager.current.string("Venus Random Info 3"),
        LanguageManager.current.string("Venus Random Info 4"),
        LanguageManager.current.string("Venus Random Info 5")
    ]
        ...
        NavigationStack {
            VStack {
                ...
                HStack {
                    ...
                    Button(action: {
                        if selectedTab == "Wiki" {
                            UIPasteboard.general.string = "https://en.wikipedia.org/wiki/Venus"
                        } else {
                ...
                VStack {
                    if selectedTab == "Overview" {
                        ...
                        VStack {
                            Text(LanguageManager.current.string("Wikipedia: Venus"))
                                .font(.headline)
                                .foregroundColor(.white)
                                .padding()
                        ...
                        CommentVenusView(planetId: planetId).environmentObject(commentVM)
                    } else {
        ...
        var body: some View {
            ZStack {
                RealityView { content in
                    ...
                    venusMaterial.emissiveIntensity = glowIntensity
                    ...
                    Task { @MainActor in
                        ...
                        while true {
                            ...
                            venusEntity.transform.rotation = rotationY * rotationX
                ...
                .frame(height: 300)
                .padding()
                .matchedGeometryEffect(id: "venus-\(planet.id)", in: animation)
                .gesture(
                    DragGesture()
                        .onChanged { value in
                            isDragging = true
    ...
    struct InformationView: View {
        ...
        var body: some View {
            GeometryReader { geometry in
                VStack {
                    RealityView { content in
                        let venusMesh = MeshResource.generateSphere(radius: 0.5)
                        var venusMaterial = PhysicallyBasedMaterial()
                        do {
                            let textureResource = try await TextureResource(named: "Venus_Texture")
                            venusMaterial.baseColor = .init(texture: .init(textureResource))
                        ...
                        Task { @MainActor in
                            ...
                            while true {
                                ...
                                venusEntity.transform.rotation = rotation
                                try? await Task.sleep(nanoseconds: 16_666_666)
                            }
                        }
                    }
                    ...
                    ScrollView {
                        VStack(alignment: .leading, spacing: 16) {
                            ...
                            Text(LanguageManager.current.string("Venus About Description"))
                                .font(.body)
                                .foregroundColor(.white)
                                .padding(.horizontal)
                                .transition(.opacity)
                            ...
                            LazyVGrid(columns: [
                                ...
                                ForEach([
                                    ...
                                    "https://www.youtube.com/embed/7LKCeO8S63k"
                                ],  id: \.self) { url in
    ...
    struct VideoListView: View {
        let videoURLs = [
            "https://www.youtube.com/embed/djP-IdHFQWU",
            "https://www.youtube.com/embed/7LKCeO8S63k",
            "https://www.youtube.com/embed/MYyXULpYubo",
            "https://www.youtube.com/embed/bfVJBZJjcYg",
            "https://www.youtube.com/embed/VrjJVbd8FjI"
        ]
        ...
        var body: some View {
            ScrollView {
                VStack(alignment: .leading, spacing: 2) {
                    infoRow(icon: "globe", color: .yellow,
                            text: LanguageManager.current.string("Venus By The Numbers Planet Type"))
                    infoRow(icon: "circle.fill", color: .orange,
                            text: LanguageManager.current.string("Venus By The Numbers Radius"))
                    infoRow(icon: "sun.max.fill", color: .red,
                            text: LanguageManager.current.string("Venus By The Numbers Distance"))
                    infoRow(icon: "moon.fill", color: .gray,
                            text: LanguageManager.current.string("Venus By The Numbers Moons"))
                    infoRow(icon: "gauge", color: .cyan,
                            text: LanguageManager.current.string("Venus By The Numbers Gravity"))
                    infoRow(icon: "arrow.triangle.2.circlepath", color: .purple,
                            text: LanguageManager.current.string("Venus By The Numbers Tilt"))
                    infoRow(icon: "calendar", color: .orange,
                            text: LanguageManager.current.string("Venus By The Numbers Year"))
                    infoRow(icon: "clock", color: .pink,
                            text: LanguageManager.current.string("Venus By The Numbers Day"))
                    infoRow(icon: "thermometer", color: .red,
                            text: LanguageManager.current.string("Venus By The Numbers Temperature"))
                    infoRow(icon: "hourglass", color: .teal,
                            text: LanguageManager.current.string("Venus By The Numbers Age"))
                }
                .padding()
    ...
    struct GalleriesView: View {
        let animation: Namespace.ID
        let images = ["Venus", "Venus01", "Venus02", "Venus03", "Venus04", "Venus05"]
    ...
    struct MythView: View {
        ...
        private let myths: [Myth] = [
            Myth(culture: LanguageManager.current.string("Roman Myth Culture"), godName: LanguageManager.current.string("Roman Myth God"), description: LanguageManager.current.string("Roman Myth Description"), imageName: "VenusGod_Venus"),
            Myth(culture: LanguageManager.current.string("Greek Myth Culture"), godName: LanguageManager.current.string("Greek Myth God"), description: LanguageManager.current.string("Greek Myth Description"), imageName: "VenusGod_Aphrodite"),
            Myth(culture: LanguageManager.current.string("Egyptian Myth Culture"), godName: LanguageManager.current.string("Egyptian Myth God"), description: LanguageManager.current.string("Egyptian Myth Description"), imageName: "VenusGod_Hathor"),
            Myth(culture: LanguageManager.current.string("Hindu Myth Culture"), godName: LanguageManager.current.string("Hindu Myth God"), description: LanguageManager.current.string("Hindu Myth Description"), imageName: "VenusGod_Shukra")
        ]
        ...
        var body: some View {
            ZStack {
                ...
                ScrollView {
                    VStack(spacing: 24) {
                        VStack(spacing: 8) {
                            Text(LanguageManager.current.string("Venus Myths Title"))
                                .font(.title.bold())
                                .foregroundColor(.white)
                            
                            Text(LanguageManager.current.string("Venus Myths Description"))
                                .font(.body)
                                .foregroundColor(.white.opacity(0.8))
    ...
    struct InternalView: View {
        ...
        struct VenusLayer: Identifiable {
            let id = UUID()
            let name: String
            let description: String
        ...
        private let layers: [VenusLayer] = [
            VenusLayer(
                name: LanguageManager.current.string("Venus Layer Core"),
                description: LanguageManager.current.string("Venus Layer Core Description"),
                color: LinearGradient(colors: [.red, .orange], startPoint: .topLeading, endPoint: .bottomTrailing),
                icon: "flame.fill"
            ),
            VenusLayer(
                name: LanguageManager.current.string("Venus Layer Mantle"),
                description: LanguageManager.current.string("Venus Layer Mantle Description"),
                color: LinearGradient(colors: [.orange, .brown], startPoint: .topLeading, endPoint: .bottomTrailing),
                icon: "globe.asia.australia.fill"
            ),
            VenusLayer(
                name: LanguageManager.current.string("Venus Layer Crust"),
                description: LanguageManager.current.string("Venus Layer Crust Description"),
                color: LinearGradient(colors: [.brown, .yellow], startPoint: .top, endPoint: .bottom),
                icon: "leaf.fill"
            ),
            VenusLayer(
                name: LanguageManager.current.string("Venus Layer Atmosphere"),
                description: LanguageManager.current.string("Venus Layer Atmosphere Description"),
        ...
        var body: some View {
            ScrollView {
                VStack(spacing: 20) {
                    Text(LanguageManager.current.string("Venus Internal Title"))
                        .font(.title2)
                        .fontWeight(.bold)
                        .foregroundColor(.white)
                        .padding(.top, 10)
                    ...
                    Image("Venus")
                        ...
                        .clipShape(RoundedRectangle(cornerRadius: 12))
                        .padding()
                        .matchedGeometryEffect(id: "internal-venus", in: animation)
                }
                .padding(.bottom, 30)
            }
            .background(
            ...
            ScrollView {
                VStack(spacing: 20) {
                    Image("Venus")
                        ...
                        .shadow(radius: 8)
                        .padding(.horizontal)
                        .matchedGeometryEffect(id: "indepth-venus", in: animation)
                    
                    Text(LanguageManager.current.string("Venus In Depth Title"))
                        .font(.title2.bold())
                        .foregroundColor(.white)
                        .padding(.horizontal)
                    ...
                    VStack(spacing: 16) {
                        InfoCardView(
                            icon: "cloud.fill",
                            title: LanguageManager.current.string("Venus In Depth Atmosphere"),
                            description: LanguageManager.current.string("Venus In Depth Atmosphere Description"),
                            iconColor: .yellow
                        )
                        
                        InfoCardView(
                            icon: "flame.fill",
                            title: LanguageManager.current.string("Venus In Depth Surface"),
                            description: LanguageManager.current.string("Venus In Depth Surface Description"),
                            iconColor: .orange
                        )
                        
                        InfoCardView(
                            icon: "wave.3.forward.circle.fill",
                            title: LanguageManager.current.string("Venus In Depth Volcanism"),
                            description: LanguageManager.current.string("Venus In Depth Volcanism Description"),
                            iconColor: .red
                        )
                        
                        InfoCardView(
                            icon: "binoculars.fill",
                            title: LanguageManager.current.string("Venus In Depth Missions"),
                            description: LanguageManager.current.string("Venus In Depth Missions Description"),
                            iconColor: .purple
                        )
                    }
                    .padding(.horizontal)
            ...
            ScrollView {
                VStack(spacing: 24) {
                    ZStack(alignment: .bottomLeading) {
                        ...
                        Text(LanguageManager.current.string("Venus Exploration Title"))
                    ...
                    VStack(alignment: .leading, spacing: 16) {
                        MissionCardView(
                            title: LanguageManager.current.string("Venus Mission Venera"),
                            description: LanguageManager.current.string("Venus Mission Venera Description"),
                        ...
                        MissionCardView(
                            title: LanguageManager.current.string("Venus Mission Magellan"),
                            description: LanguageManager.current.string("Venus Mission Magellan Description"),
                        ...
                        MissionCardView(
                            title: LanguageManager.current.string("Venus Mission Akatsuki"),
                            description: LanguageManager.current.string("Venus Mission Akatsuki Description"),
                            icon: "cloud.sun.fill",
                            animation: animation,
                            id: "akatsuki"
                        )
                    ...
                    Text(LanguageManager.current.string("Venus Exploration Quote"))
                        .font(.title3.italic())
...
#Preview {
    VenusView(
        planet: PlanetModel(name: "Venus", planetDescription: "The second planet from the Sun, known for its thick atmosphere and extreme heat."),
